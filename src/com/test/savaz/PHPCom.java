...
public class PHPCom 
{
    ...
    private static String url_create_session = "http://gongfutimer.dyndns.org/insertsession.php";
    private static String url_create_brewing = "http://gongfutimer.dyndns.org/insertsessiond.php";
